...
func (f *Formatter2) init(entry *logrus.Entry) {
...
func (f *Formatter2) checkIfTerminal(w io.Writer) bool {
	switch v := w.(type) {
	case *os.File:
...
func (f *Formatter2) printColored(b *bytes.Buffer, entry *logrus.Entry, keys []string, timestampFormat string, colorScheme *compiledColorScheme) {
...
func (f *Formatter2) needsQuoting(text string) bool {
...
func (f *Formatter2) appendKeyValue(b *bytes.Buffer, key string, value interface{}, appendSpace bool) {
	b.WriteString(key)
	b.WriteByte('=')
...
func (f *Formatter2) appendValue(b *bytes.Buffer, value interface{}) {
